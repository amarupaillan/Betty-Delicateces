...
const products: Product[] = [
  {
    ...
    ingredients: 'Harina, azúcar, huevos, leche evaporada, leche condensada, crema de leche, vainilla.',
    category: 'Postres',
    image: '/src/pages/Products/3 leches 4200.JPG',
    featured: true
  },
  {
    id: '2',
    ...
    ingredients: 'Harina, levadura, huevos, azúcar, mantequilla, leche, vainilla, crema pastelera.',
    category: 'Bollería',
    image: '/src/pages/Products/berlin 1600.JPG',
    featured: true
  },
  {
    id: '3',
    ...
    ingredients: 'Harina, levadura, huevos, mantequilla, leche, jamón, queso.',
    category: 'Panes',
    image: '/src/pages/Products/cachito 2400.JPG'
  },
  {
    id: '4',
    ...
    ingredients: 'Harina, manteca, camarones, queso, cebolla, especias.',
    category: 'Empanadas',
    image: '/src/pages/Products/camaron queso 3200.JPG',
    featured: true
  },
  {
    id: '5',
    ...
    ingredients: 'Harina, manteca, champiñones, queso, cebolla, especias.',
    category: 'Empanadas',
    image: '/src/pages/Products/champiñon queso 3200.JPG'
  },
  {
    id: '6',
    name: 'Chilenito',
    ...
    ingredients: 'Harina, mantequilla, azúcar, manjar, vainilla.',
    category: 'Dulces',
    image: '/src/pages/Products/chilenito 1200.JPG',
    featured: true
  },
  {
    id: '7',
    ...
    ingredients: 'Harina, azúcar, huevos, mantequilla, leche, esencia de vainilla.',
    category: 'Dulces',
    image: '/src/pages/Products/delicias 1300.JPG'
  },
  {
    id: '8',
    ...
    ingredients: 'Harina, mantequilla, azúcar, huevos, manzanas, canela, crema.',
    category: 'Tartas',
    image: '/src/pages/Products/kucheten de manzana  3400.JPG',
    featured: true
  },
  {
    id: '9',
    ...
    ingredients: 'Harina, mantequilla, azúcar, levadura, huevos, vainilla, relleno dulce.',
    category: 'Bollería',
    image: '/src/pages/Products/medialuna rellena 1600.JPG'
  },
  {
    id: '10',
    name: 'Mendozino',
    ...
    ingredients: 'Harina, azúcar, manteca, huevos, vainilla, dulce de leche.',
    category: 'Dulces',
    image: '/src/pages/Products/mendozino 1900.JPG'
  },
  {
    id: '11',
    name: 'Milhojas',
    ...
    ingredients: 'Harina, mantequilla, manjar, azúcar glacé.',
    category: 'Postres',
    image: '/src/pages/Products/milhojas 4500.JPG',
    featured: true
  },
  {
    id: '12',
    ...
    ingredients: 'Leche, helado de vainilla, frutillas frescas, azúcar, crema batida.',
    category: 'Bebidas',
    image: '/src/pages/Products/milkshake de frutilla 5900.JPG'
  },
  {
    id: '13',
    name: 'Milkshake Oreo',
    ...
    ingredients: 'Leche, helado de vainilla, galletas Oreo, crema batida, salsa de chocolate.',
    category: 'Bebidas',
    image: '/src/pages/Products/milkshake oreo 5900 .JPG'
  },
  {
    id: '14',
    name: 'Minito',
    ...
    ingredients: 'Harina, azúcar, huevos, mantequilla, vainilla.',
    category: 'Dulces',
    image: '/src/pages/Products/minito 1200.JPG'
  },
  {
    id: '15',
    ...
    ingredients: 'Harina, manteca, queso mozzarella, tomate, orégano, jamón.',
    category: 'Empanadas',
    image: '/src/pages/Products/napolitana 2900.JPG',
    featured: true
  },
  {
    id: '16',
    ...
    ingredients: 'Harina, mantequilla, huevos, limones, leche condensada, azúcar.',
    category: 'Tartas',
    image: '/src/pages/Products/pie de limón 3500.JPG'
  },
  {
    id: '17',
    ...
    ingredients: 'Galletas, mantequilla, pulpa de maracuyá, leche condensada, huevos, azúcar.',
    category: 'Tartas',
    image: '/src/pages/Products/pie de maracuya 3500.JPG',
    featured: true
  },
  {
    id: '18',
    ...
    ingredients: 'Harina, manteca, carne picada, cebolla, pasas, huevo duro, aceitunas, merquén, comino.',
    category: 'Empanadas',
    image: '/src/pages/Products/pino merquen 2900.JPG'
  },
  {
    id: '19',
    ...
    ingredients: 'Harina, manteca, carne picada, cebolla, pasas, huevo duro, aceitunas, comino, pimentón.',
    category: 'Empanadas',
    image: '/src/pages/Products/pino tradicional 2900.JPG',
    featured: true
  },
  {
    id: '20',
    ...
    ingredients: 'Harina, manteca, pollo, ajo, cebolla, especias.',
    category: 'Empanadas',
    image: '/src/pages/Products/pollo al ajillo 2900.JPG'
  },
  {
    id: '21',
    ...
    ingredients: 'Harina, manteca, pollo, champiñones, cebolla, crema, harina, mantequilla.',
    category: 'Empanadas',
    image: '/src/pages/Products/pollo champiñon a la crema 3200.JPG'
  },
  {
    id: '22',
    ...
    ingredients: 'Harina, mantequilla, queso.',
    category: 'Empanadas',
    image: '/src/pages/Products/queso masa de hoja 2900.JPG',
    featured: true
  },
  {
    id: '23',
    ...
    ingredients: 'Harina, azúcar, mantequilla, huevos, cacao, colorante alimentario, buttermilk, bicarbonato, queso crema, azúcar glass.',
    category: 'Postres',
    image: '/src/pages/Products/red velvel 4500.JPG'
  },
  {
    id: '24',
    name: 'Trozo de Amor',
    ...
    ingredients: 'Chocolate, harina, azúcar, huevos, mantequilla, crema, vainilla.',
    category: 'Postres',
    image: '/src/pages/Products/trozo de amor 4500.JPG'
  },
  {
    id: '25',
    name: 'Trufas',
    ...
    ingredients: 'Chocolate, crema, mantequilla, licor (opcional), cacao en polvo.',
    category: 'Dulces',
    image: '/src/pages/Products/trufas 1300.JPG'
  },
  {
    id: '26',
    ...
    ingredients: 'Harina, manteca vegetal, espinacas, cebolla, queso, nuez moscada.',
    category: 'Empanadas',
    image: '/src/pages/Products/vegetariana de espinaca 3200.JPG'
  }
];
